...
/*
  ...
  Version 86 - Jun 30, 2020  TimeLapseAvi86x.ino 
  ...
  Hardware
    - to use PIR function, put an active high PIR or microwave on pin 12 with a 10k resistor (brown,black,orange) between pin 12 and PIR outputto avoid antagonizing sd card
...
const int avi_header[AVIOFFSET] PROGMEM = {
  ...
  0x76, 0x38, 0x36, 0x20, 0x4C, 0x49, 0x53, 0x54, 0x00, 0x01, 0x0E, 0x00, 0x6D, 0x6F, 0x76, 0x69,
};
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
// save_photo_dated - just save one picture as a jpg
//
...
void make_avi( ) {
  ...
  if (newfile == 0 && recording == 1) {                                     // open the file
    ...
    newfile = 1;
    save_photo_dated();                                      // save a photo as jpg on sd
...
<h3><a href="http://%s/start?framesize=VGA&length=1800&interval=500&quality=10&repeat=300&speed=15&gray=0">VGA 2 fps, for 30 minutes repeat, 15x playback</a></h3>
<h3><a href="http://%s/start?framesize=UXGA&length=1800&interval=1000&quality=12&repeat=100&speed=30&gray=0">UXGA 1 sec per frame, for 30 minutes repeat, 30x playback</a></h3>
<h3><a href="http://%s/start?framesize=UXGA&length=1800&interval=500&quality=12&repeat=100&speed=15&gray=0">UXGA 2 fps for 30 minutes repeat, 15x playback</a></h3>
<h3><a href="http://%s/start?framesize=UXGA&length=3600&interval=10000&quality=12&repeat=300&speed=300">UXGA 10 sec per frame for 1 hour x300 repeat, Q12</a></h3>
<h3><a href="http://%s/start?framesize=UXGA&length=3600&interval=10000&quality=12&repeat=300&speed=150&gray=0">UXGA 5 sec per frame for 1 hour x150 repeat</a></h3>
<h3><a href="http://%s/start?framesize=UXGA&length=7200&interval=30000&quality=12&repeat=100&speed=900&gray=0">UXGA 30 sec per frame for 2 hours repeat</a></h3>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  sprintf(the_page, msg, devname, devname, vernum, strdate, use, tot, rssi, diskspeed, recording, PIRrecording, PIRenabled, EnableBOT, fname,
          ...
          quality, framesize, repeat, xspeed, gray, localip, localip, localip, localip, localip, localip);
